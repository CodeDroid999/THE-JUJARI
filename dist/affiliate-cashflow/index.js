(() => {
  ...
  new Vue({
    ...
    data: { loading: !0, cashflows: { data: [] } },
    methods: {
      getCashflows() {
        t.get(e.affiliateCashflowList).then((e) => {
          0 === e.code && (this.cashflows = e.data), (this.loading = !1);
        });
      },
      handlePageClick(e, a) {
        (this.loading = !0),
          t.get(e).then((e) => {
            if (0 === e.code)
              if ("replace" === a) this.cashflows = e.data;
              else if ("push" === a) {
                const a = e.data,
                  t = [...this.cashflows.data, ...e.data.data];
                (a.data = t), (this.cashflows = a);
              }
            this.loading = !1;
          });
      },
