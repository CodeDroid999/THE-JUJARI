(() => {
  ...
  new Vue({
    ...
    data: { loading: !0, activities: { data: [] } },
    methods: {
      getActivities() {
        t.get(e.affiliateActivityList).then((e) => {
          0 === e.code && (this.activities = e.data), (this.loading = !1);
        });
      },
      handlePageClick(e, a) {
        (this.loading = !0),
          t.get(`${e}${params}`).then((e) => {
            if (0 === e.code)
              if ("replace" === a) this.activities = e.data;
              else if ("push" === a) {
                const a = e.data,
                  t = [...this.activities.data, ...e.data.data];
                (a.data = t), (this.activities = a);
              }
            this.loading = !1;
          });
      },
