(() => {
  ...
  new Vue({
    ...
    data: { loading: !0, subordinates: { data: [] } },
    methods: {
      getSubordinates() {
        t.get(e.affiliateUserSubordinate).then((e) => {
          0 === e.code && (this.subordinates = e.data), (this.loading = !1);
        });
      },
      handlePageClick(e, a) {
        (this.loading = !0),
          t.get(e).then((e) => {
            if (0 === e.code)
              if ("replace" === a) this.subordinates = e.data;
              else if ("push" === a) {
                const a = e.data,
                  t = [...this.subordinates.data, ...e.data.data];
                (a.data = t), (this.subordinates = a);
              }
            this.loading = !1;
          });
      },
